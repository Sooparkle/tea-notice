...
const TermsAndConditions = () => {
  ...
  return (
    ...
    >
      ...
      <p>These terms and conditions apply to the Tea dairy app (hereby referred to as "Application") for mobile devices that was created by teateachada (hereby referred to as "Service Provider") as an Ad Supported service.</p>
      ...
      <p>These terms and conditions are effective as of {effectiveDate}</p>

      <strong>Contact Us</strong>
      <p>If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at teateachada.official@gmail.com.</p>
      <hr />
